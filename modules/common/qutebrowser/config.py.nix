...
in ''
  ...
  # pass bindings
  config.bind(',p', "spawn --userscript qute-pass -d '${dmenu}'")
  config.bind(',e', "spawn --userscript qute-pass --username-only -d '${dmenu}'")
  config.bind(',w', "spawn --userscript qute-pass --password-only -d '${dmenu}'")
  # mpv bindings
