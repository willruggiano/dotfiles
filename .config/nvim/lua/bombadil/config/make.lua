...
vim.cmd [[command! -bang Make lua require("make").compile({}, "<bang>" == "!")]]
vim.cmd [[command! -bang -nargs=1 -complete=custom,ListBuildTargets MakeTarget lua require("make").compile({ build_target = <q-args> }, "<bang>" == "!")]]
